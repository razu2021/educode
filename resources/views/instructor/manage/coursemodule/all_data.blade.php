    ...
    <div class="col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 col-xxl-3 mb-4">
      <div class="card h-100 shadow-sm border-0">
        ...
        @if($data->CourseModule == '')
            <a class="btn btn-sm btn-outline-primary w-100" href="{{route('ins_course_module.add',[$data->id, $data->slug])}}"> Create Coupon </a>
        @else 
          <div class="d-flex justify-content-around ">
          <a class="btn btn-sm btn-outline-primary w-50 mx-1" href="{{route('ins_course_module.edit',[$data->CourseModule->id, $data->CourseModule->slug])}}"> Edit Coupon </a>
          <a class="btn btn-sm btn-outline-info w-50  mx-1" href="{{route('ins_course_module.view',[$data->CourseModule->id, $data->CourseModule->slug])}}"> View Coupon </a>
          </div>
        @endif 
        </div>
      </div>
