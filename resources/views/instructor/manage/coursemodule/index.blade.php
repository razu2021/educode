        ...
        <table class="table table-sm fs-10 mb-0 overflow-hidden">
          <thead class="bg-200">
            <tr class="">
              ...
              <th class="text-900 sort pe-1 align-middle white-space-nowrap" data-sort="name">Coupon amount</th>
              <th class="text-900 sort pe-1 align-middle white-space-nowrap" data-sort="title">Coupon Type</th>
              <th class="text-900 sort pe-1 align-middle white-space-nowrap" data-sort="des">Max Used</th>
              <th class="text-900 sort pe-1 align-middle white-space-nowrap " data-sort="time">Used</th> </th>
          ...
          <tbody class="list" id="table-purchase-body">
            ...
            <tr class="btn-reveal-trigger">
              ...
              <td class="align-middle white-space-nowrap email">{{$data->discount_amount ?? 'No Data' }}</td>
              <td class="align-middle white-space-nowrap product">{{$data->discount_type ?? 'No Discount'}}</td>
              <td class="align-middle white-space-nowrap product">{{$data->max_usage ?? 'No Data'}}</td>
              <td class="align-middle white-space-nowrap product">{{$data->used ?? 'No Data'}}</td>
