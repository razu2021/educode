...
<div class="container card  py-4" id="recentPurchaseTable" data-list="{&quot;valueNames&quot;:[&quot;name&quot;,&quot;email&quot;,&quot;product&quot;,&quot;payment&quot;,&quot;amount&quot;],&quot;page&quot;:8,&quot;pagination&quot;:true}">
  ...
  <div class="row flex-between-center mb-4">
      ...
      <div id="table-purchases-replace-element" class="d-flex align-items-center">
          <!-- New Button -->
          <a href="{{route('ins_course_quize_qustion.all')}}">
                ...
                <div class="card shadow-sm border-0 h-100 text-center p-3">
                    <div class="card-body">
                        ...
                        <span class="badge bg-primary mb-2">
                           {{ $data->total_quiz_questions   ?? 'N/A' }}  {{ Str::plural('Qustions', $data->total_quiz_questions ) }}
                        </span>
                        <a href="{{route('ins_course_quize_qustion.add',[$data->id,$data->slug])}}" class="btn btn-sm btn-outline-primary w-100 mt-2">
                           Create Quiz Questions
                        </a>
                        <a href="{{route('ins_course_quize_qustion.all_topics',[$data->id,$data->slug])}}" class="btn btn-sm btn-outline-primary w-100 mt-2">
                            View all Questions
                        </a>
                    </div>
                </div>
