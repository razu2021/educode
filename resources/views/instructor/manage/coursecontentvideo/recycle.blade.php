              ...
              <td class="align-middle white-space-nowrap text-end">
                <div class="dropstart font-sans-serif position-static d-inline-block">
                  ...
                  <div class="dropdown-menu dropdown-menu-end border py-2" aria-labelledby="dropdown-recent-purchase-table-0">
                    ...
                    <form id="deleteForm{{ $data->id }}" action="{{ route('ins_course_content_video.delete', $data->id) }}" method="POST" style="display: none;">
                      @csrf
                      @method('DELETE')
                    </form>
                    ...
                    <!-- Restore Button with JS Confirm -->
                        ...
                        <!-- Hidden Form -->
                        <form id="restoreForm{{ $data->id }}" action="{{ route('ins_course_content_video.restore', $data->id) }}" method="POST" style="display: none;">
                        @csrf
