                ...
                <div class="card-body">
                    ...
                    <div class="accordion" id="accordionExample">
                        @foreach ($all as $data)
                            ...
                            @foreach ($data->courseAttachment as $topic)
                                    ...
                                    <div class="accordion-collapse collapse " id="collapse{{$topic->id}}" aria-labelledby="heading1" data-bs-parent="#accordionExample">
                                      <div class="mx-4 my-3 d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center" style=" box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px; padding:10px 10px">
                                          ...
                                          <div class="preview">
                                            ...
                                            <a class="btn btn-sm mx-2 btn-outline-warning " href="{{route('ins_course_attachment.edit',[$topic->id,$topic->slug])}}"><span> <i class="bi bi-pencil-square"></i> </span></a>
                                            <a class="btn btn-sm mx-2 btn-outline-info " href="{{route('ins_course_attachment.view',[$topic->id,$topic->slug])}}"><span> <i class="bi bi-eye-fill"></i></span></a>
                                          </div>
                                      </div>
                                      {{-- end --}}
                                    </div>
