...
@section('instructor_contents')
    <main>
        <div class="container">
          ...
          <form action="{{route('ins_course_quize.submit')}}" method="post" enctype="multipart/form-data">
          @csrf
            <div class="row">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="row gx-2">
                                ...
                                {{-- category end --}}
                                <div class="col-12 mb-1">
                                    <label class="form-label" for="title"> Quiz Title : <span class="text-danger"><i class="bi bi-star-fill"></i></span></label>
                                ...
                                {{-- end --}}
                                <div class="col-12 mb-1">
                                    <label class="form-label" for="description"> Quiz Description/Quiz Porpuse :</label>
                                ...
                                {{-- end --}}
                                 <div class="col-3 mb-1">
                                    ...
                                    <input type="number" name="quize_time" id="quize_time"  class="form-control" value="{{old('quize_time')}}" required>
                                ...
                                {{-- end --}}
                                 <div class="col-3 mb-1">
                                    ...
                                    <input type="number" name="pass_mark" id="pass_mark"  class="form-control" value="{{old('pass_mark')}}" required>
