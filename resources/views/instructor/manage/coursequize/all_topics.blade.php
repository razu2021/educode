            ...
            <div class="card mb-3">
                <div class="card-body">
                  <div class="row flex-between-center">
                    <div class="col-md">
                      <h5 class="mb-2 mb-md-0">All Attachments </h5>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                    ...
                    <div class="accordion" id="accordionExample">
                        @foreach ($all as $data)
                            ...
                            @foreach ($data->courseQuizes as $topic)
                                <div class="accordion-item">
                                    ...
                                    <div class="accordion-collapse collapse " id="collapse{{$topic->id}}" aria-labelledby="heading1" data-bs-parent="#accordionExample">
                                      <div class="mx-4 my-3 d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center" style=" box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px; padding:10px 10px">
                                          <div class="title"><span><i class="bi bi-file-earmark-pdf"></i> </span> {{$topic->description ? Str::words($topic->description,'10') :'File Not Found'}}</div>
                                          <div class="preview">
                                            <a class="btn btn-sm mx-2 btn-outline-warning " href="{{route('ins_course_quize.edit',[$topic->id,$topic->slug])}}"><span> <i class="bi bi-pencil-square"></i> </span></a>
                                            <a class="btn btn-sm mx-2 btn-outline-info " href="{{route('ins_course_quize.view',[$topic->id,$topic->slug])}}"><span> <i class="bi bi-eye-fill"></i></span></a>
                                          </div>
                                      </div>
                                      {{-- end --}}
                                    </div>
