...
@section('admin_contents')
    <main>
        <div class="container">
          ...
          <form action="{{route('embedmap.submit')}}" method="post" enctype="multipart/form-data">
          @csrf
            <div class="row">
                <div class="col-lg-8">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="row gx-2">
                                <div class="col-12 mb-1">
                                    ...
                                    <input class="form-control" name="address_line1" id="address_line1" type="text" value="{{old('address_line1')}}">
                              ...
                              <!-- end -->
                                <div class="col-12 mb-1">
                                    ...
                                    <input class="form-control" name="address_line2" id="address_line2" type="text" value="{{old('address_line2')}}">
                              ...
                              <!-- end -->
                                <div class="col-6 mb-1">
                                    ...
                                    <input class="form-control" name="latitude" id="latitude" type="text" value="{{old('latitude')}}">
                                    <label class="text-danger fw-medium">@error('latitude') {{$message}} @enderror</label>
                                </div>
                              <!-- end -->
                                <div class="col-6 mb-1">
                                    <label class="form-label" for="longitude">Latitude: </label>
                                    <input class="form-control" name="longitude" id="longitude" type="text" value="{{old('longitude')}}">
                              ...
                              <!-- end -->
                                <div class="col-12 mb-1">
                                    ...
                                    <input class="form-control" name="static_map" id="static_map" type="text" value="{{old('static_map')}}">
