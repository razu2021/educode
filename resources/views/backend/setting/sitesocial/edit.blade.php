...
@section('admin_contents')
    <main>
        <div class="container">
          ...
          <form action="{{route('sitesocial.update')}}" method="post" enctype="multipart/form-data">
          @csrf
            <div class="row">
                <div class="col-lg-8">
                    <div class="card mb-3">
                            ...
                            <div class="row gx-2">
                               ...
                               <div class="col-12 mb-1">
                                ...
                                <span class="input-group-text" id="selectedIconPreview">@</span>
                                  <input type="text" name="icon" id="selectedIconInput" value="{{$data->icon}}" class="form-control" placeholder="Select icon" aria-label="Recipient’s username" aria-describedby="button-addon2">
                                ...
                                <div class="col-12 mb-1">
                                    ...
                                    <input class="form-control" name="order" id="order" type="number" value="{{$data->order}}">
