...
@section('admin_contents')
    <main>
        <div class="container">
          ...
          <form action="{{route('iconmanagement.submit')}}" method="post" enctype="multipart/form-data">
          @csrf
            <div class="row">
                <div class="col-lg-8">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="row gx-2">
                                ...
                                <div class="col-12 mb-1">
                                    <label class="form-label" for="icons">Added a new Icon:</label>
                                    <input class="form-control" name="icons" id="icons" type="text" value="{{old('icons')}}">
