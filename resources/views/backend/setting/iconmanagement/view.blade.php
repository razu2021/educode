                          ...
                          <div class="row align-items-center">
                            ...
                            <div class="col-xxl-12 col-md-7">
                              ...
                              <div class="">
                                ...
                                <div class="d-flex border-bottom py-2 ">
                                    <h6><span class="text-success px-1"> <i class="bi bi-info-circle"></i> </span> <strong class="px-2"> Created by :  </strong> {{ $data->creator->name?? 'No Name Found' }}  </h6>
                                </div>
                                <div class="d-flex border-bottom py-2 ">
