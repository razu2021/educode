...
@section('admin_contents')
    <main>
        <div class="container">
          ...
          <form action="{{route('googletagmanager.submit')}}" method="post" enctype="multipart/form-data">
          @csrf
            <div class="row">
                <div class="col-lg-8">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="row gx-2">
                                ...
                                <div class="col-12 mb-1">
                                    <label class="form-label" for="tag_manager_id">Google Tag Manager ID </label>
                                    <input class="form-control" name="tag_manager_id" id="tag_manager_id" type="text" value="{{old('tag_manager_id')}}">
