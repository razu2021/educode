            ...
            <div class="card mb-3">
                <div class="card-body">
                  <div class="row flex-between-center">
                    ...
                    <div class="col-auto">
                        <button class="btn btn-link text-secondary p-0 me-3 fw-medium" role="button"><a href="{{route('googletagmanager.add')}}">Discard</a></button>
                        <button class="btn btn-primary" role="button"> <a class="text-white" href="{{route('googletagmanager.all')}}">All Items </a> </button>
                    </div>
                  </div>
                </div>
              </div>
          <form action="{{route('googletagmanager.update')}}" method="post" enctype="multipart/form-data">
          @csrf
            <div class="row">
                <div class="col-lg-8">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="row gx-2">
                                ...
                                <div class="col-12 mb-1">
                                    <label class="form-label" for="tag_manger_id">Google Tag Manager ID:</label>
                                    <input class="form-control" name="tag_manager_id" id="tag_manager_id" type="text" value="{{$data->tag_manager_id}}">
                                    <label class="text-danger fw-medium">@error('tag_manager_id') {{$message}} @enderror</label>
                                </div>
