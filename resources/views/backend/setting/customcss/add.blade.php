...
@section('admin_contents')
    <main>
        <div class="container">
          ...
          <form action="{{route('customcss.submit')}}" method="post" enctype="multipart/form-data">
          @csrf
            <div class="row">
                <div class="col-lg-8">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="row gx-2">
                                ...
                                <div class="col-12 mb-1">
                                   ...
                                   <input type="text" name="css_note" id="css_note" class="form-control">
                                    <label class="text-danger fw-medium">@error('css_note') {{$message}} @enderror</label>
                                </div>
                              <!-- end -->
                                <div class="col-12 mb-1">
                                    <label class="form-label" for="title">Custom Css:</label>
