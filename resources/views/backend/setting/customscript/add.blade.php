...
@section('admin_contents')
    <main>
        <div class="container">
          ...
          <form action="{{route('customscript.submit')}}" method="post" enctype="multipart/form-data">
          @csrf
            <div class="row">
                <div class="col-lg-8">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="row gx-2">
                                ...
                                <div class="col-12 mb-1">
                                   ...
                                   <input type="text" name="script_note" id="script_note" class="form-control">
                              ...
                              <!-- end -->
                                <div class="col-12 mb-1">
                                    ...
                                    <textarea name="custom_script" id="custom_script" class="form-control"></textarea>
