            ...
            <div class="card mb-3">
                <div class="card-body">
                  <div class="row flex-between-center">
                    ...
                    <div class="col-auto">
                        <button class="btn btn-link text-secondary p-0 me-3 fw-medium" role="button"><a href="{{route('customscript.add')}}">Discard</a></button>
                        <button class="btn btn-primary" role="button"> <a class="text-white" href="{{route('customscript.all')}}">All Items </a> </button>
                    </div>
                  </div>
                </div>
              </div>
          <form action="{{route('customscript.update')}}" method="post" enctype="multipart/form-data">
          @csrf
            <div class="row">
                <div class="col-lg-8">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="row gx-2">
                                ...
                                <div class="col-12 mb-1">
                                    <label class="form-label" for="script_note">Custom Script:</label>
                                   <input type="text" name="script_note" id="script_note" class="form-control" value="{{$data->script_note}}">
                                    <label class="text-danger fw-medium">@error('script_note') {{$message}} @enderror</label>
                                </div>
                                <div class="col-12 mb-1">
                                    <label class="form-label" for="custom_script">Custom Script:</label>
                                    <textarea name="custom_script" id="custom_script" class="form-control" rows="10" value="{{$data->custom_script}}">{{$data->custom_script}}</textarea>
                                    <label class="text-danger fw-medium">@error('custom_script') {{$message}} @enderror</label>
                                </div>
