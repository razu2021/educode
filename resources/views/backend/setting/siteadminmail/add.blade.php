...
@section('admin_contents')
    <main>
        <div class="container">
          ...
          <form action="{{route('siteadminmail.submit')}}" method="post" enctype="multipart/form-data">
          @csrf
            <div class="row">
                <div class="col-lg-8">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="row gx-2">
                                ...
                                <div class="col-12 mb-1">
                                    ...
                                    <input class="form-control" name="mail_user" id="mail_user" type="text" value="{{old('mail_user')}}">
                                ...
                                <div class="col-12 mb-1">
                                    ...
                                    <input class="form-control" name="mail" id="mail" type="text" value="{{old('mail')}}">
