            ...
            <div class="card mb-3">
                <div class="card-body">
                  <div class="row flex-between-center">
                    ...
                    <div class="col-auto">
                        <button class="btn btn-link text-secondary p-0 me-3 fw-medium" role="button"><a href="{{route('siteadminmail.add')}}">Discard</a></button>
                        <button class="btn btn-primary" role="button"> <a class="text-white" href="{{route('siteadminmail.all')}}">All Items </a> </button>
                    </div>
                  </div>
                </div>
              </div>
          <form action="{{route('siteadminmail.update')}}" method="post" enctype="multipart/form-data">
          @csrf
            <div class="row">
                <div class="col-lg-8">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="row gx-2">
                                ...
                                <div class="col-12 mb-1">
                                  <label class="form-label" for="mail_user">Mail User Name</label>
                                  <input class="form-control" name="mail_user" id="mail_user" type="text" value="{{$data->mail_user}}">
                                  <label class="text-danger fw-medium">@error('mail_user') {{$message}} @enderror</label>
                              </div>
                              <!-- end -->
                              <!-- end -->
                              <div class="col-12 mb-1">
                                  <label class="form-label" for="mail">Mail Address</label>
                                  <input class="form-control" name="mail" id="mail" type="text" value="{{$data->mail}}">
                                  <label class="text-danger fw-medium">@error('mail') {{$message}} @enderror</label>
                              </div>
                              <!-- end -->
