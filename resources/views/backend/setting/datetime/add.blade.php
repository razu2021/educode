            ...
            <div class="card mb-3">
                <div class="card-body">
                  <div class="row flex-between-center">
                    ...
                    <div class="col-auto">
                        <button class="btn btn-link text-secondary p-0 me-3 fw-medium" role="button"><a href="{{route('datetime.add')}}">Discard</a></button>
                        <button class="btn btn-primary" role="button"> <a class="text-white" href="{{route('datetime.all')}}">All Items </a> </button>
                    </div>
                  </div>
                </div>
              </div>
          <form action="{{route('datetime.submit')}}" method="post" enctype="multipart/form-data">
          @csrf
            <div class="row">
                <div class="col-lg-8">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="row gx-2">
                                ...
                                <div class="col-12 mb-1">
                                    <label class="form-label" for="title">Date Formate :</label>
                                    ...
                                    <label class="text-danger fw-medium">@error('date_formate') {{$message}} @enderror</label>
                                </div>
                              <!-- end -->
                                <!-- end -->
                                <div class="col-12 mb-1">
                                    <label class="form-label" for="time_formate">Time Formate :</label>
                                    <select name="time_formate" id="" class="form-control">
                                    ...
                                    <label class="text-danger fw-medium">@error('time_formate') {{$message}} @enderror</label>
                                </div>
                              <!-- end -->
