            ...
            <div class="card mb-3">
                <div class="card-body">
                  <div class="row flex-between-center">
                    ...
                    <div class="col-auto">
                        <button class="btn btn-link text-secondary p-0 me-3 fw-medium" role="button"><a href="{{route('maintenancemode.add')}}">Discard</a></button>
                        <button class="btn btn-primary" role="button"> <a class="text-white" href="{{route('maintenancemode.all')}}">All Items </a> </button>
                    </div>
                  </div>
                </div>
              </div>
          <form action="{{route('maintenancemode.submit')}}" method="post" enctype="multipart/form-data">
          @csrf
            <div class="row">
                <div class="col-lg-8">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="row gx-2">
                                <div class="col-12 mb-1">
                                    ...
                                    <input class="form-control icp icp-auto" name="title" name="icon" id="" type="text" value="fas fa-anchor">
                                ...
                                <div class="col-12 mb-1">
                                    ...
                                    <textarea name="caption" id="description"></textarea>
                                    <label class="text-danger fw-medium">@error('caption') {{$message}} @enderror</label>
                                </div>
