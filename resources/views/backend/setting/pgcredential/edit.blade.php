...
@section('admin_contents')
    <main>
        <div class="container">
          ...
          <form action="{{route('pgcredential.update')}}" method="post" enctype="multipart/form-data">
          @csrf
            <div class="row">
                <div class="col-lg-8">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                                ...
                                {{-- input hidden --}}
                                 ...
                                 <div class="col-12 mb-1">
                                  ...
                                  <select name="gateway_type" id="gateway_type" class="form-control">
                                    <option value="{{$data->gateway_type}}">{{$data->gateway_type}}</option>
                            ...
                            <!-- end -->
                              <div class="col-12 mb-1">
                                  ...
                                  <input class="form-control" name="gateway_name" id="gateway_name" type="text" value="{{$data->gateway_name}}">
                                  <label class="text-danger fw-medium">@error('gateway_name') {{$message}} @enderror</label>
                              </div>
                            <!-- end -->
                              <div class="col-12 mb-1">
                                  <label class="form-label" for="api_key">API Key </label>
                                  <input class="form-control" name="api_key" id="api_key" type="text" value="{{$data->api_key}}">
                            ...
                            <!-- end -->
                              <div class="col-12 mb-1">
                                  ...
                                  <input class="form-control" name="api_secret" id="api_secret" type="text" value="{{$data->api_secret}}">
                            ...
                            <!-- end -->
                              <div class="col-12 mb-1">
                                  ...
                                  <input class="form-control" name="webhook_secret" id="webhook_secret" type="text" value="{{$data->webhook_secret}}">
                              ...
                              <div class="col-12 mb-1">
                                  ...
                                  <input class="form-control" name="access_token" id="access_token" type="text" value="{{$data->access_token}}">
                            ...
                            <div class="col-12 mb-1">
                              ...
                              <input class="form-control" name="merchant_id" id="merchant_id" type="text" value="{{$data->merchant_id}}">
                            ...
                            <div class="col-12 mb-1">
                              ...
                              <input class="form-control" name="store_id" id="store_id" type="text" value="{{$data->store_id}}">
                            ...
                            <div class="col-12 mb-1">
                              ...
                              <input class="form-control" name="store_password" id="store_password" type="text" value="{{$data->store_password}}">
