...
@section('admin_contents')
    <main>
        <div class="container">
          ...
          <form action="{{route('emailsetup.submit')}}" method="post" enctype="multipart/form-data">
          @csrf
            <div class="row">
                <div class="col-lg-8">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="row gx-2">
                                ...
                                <div class="col-12 mb-1">
                                    ...
                                    <input class="form-control" name="mail_mailer" id="mail_mailer" type="text" placeholder="smtp or other" value="{{old('mail_mailer')}}">
                              ...
                              <!-- end -->
                                <div class="col-12 mb-1">
                                    ...
                                    <input class="form-control" name="mail_host" id="mail_host" type="text" placeholder="smtp.gmail.com" value="{{old('mail_host')}}">
                              ...
                              <!-- end -->
                                <div class="col-12 mb-1">
                                    ...
                                    <input class="form-control" name="mail_port" id="mail_port" type="text" placeholder="465" value="{{old('mail_port')}}">
                              ...
                              <!-- end -->
                                <div class="col-12 mb-1">
                                    ...
                                    <input class="form-control" name="mail_username" id="mail_username" type="text" placeholder="username!" value="{{old('mail_username')}}">
                              ...
                              <!-- end -->
                                <div class="col-12 mb-1">
                                    ...
                                    <input class="form-control" name="mail_password" id="mail_password" type="text" placeholder="password!" value="{{old('mail_password')}}">
                              ...
                              <!-- end -->
                                <div class="col-12 mb-1">
                                    ...
                                    <input class="form-control" name="mail_encryption" id="mail_encryption" type="text" placeholder="tls" value="{{old('mail_encryption')}}">
                              ...
                              <!-- end -->
                                <div class="col-12 mb-1">
                                    ...
                                    <input class="form-control" name="mail_from_address" id="mail_from_address" type="text" placeholder="example@gmail.com" value="{{old('mail_from_address')}}">
                              ...
                              <!-- end -->
                                <div class="col-12 mb-1">
                                    ...
                                    <input class="form-control" name="mail_from_name" id="mail_from_name" type="text" placeholder="your App Name" value="{{old('mail_from_name')}}">
