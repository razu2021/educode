...
@section('admin_contents')
    <main>
        <div class="container">
          ...
          <form action="{{route('coursesubcategory.submit')}}" method="post" enctype="multipart/form-data">
          @csrf
            <div class="row">
                <div class="col-lg-8">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="row gx-2">
                                ...
                                <div class="col-12 mb-1">
                                    <label class="form-label" for="course_sub_category_name">Categorie Name:</label>
                                    <input class="form-control" name="course_sub_category_name" id="course_sub_category_name" type="text" value="{{old('course_sub_category_name')}}">
                                ...
                                <div class="col-12 mb-1">
                                    ...
                                    <input class="form-control" name="course_sub_category_title" id="course_sub_category_title" type="text" value="{{old('course_sub_category_title')}}">
                                ...
                                <div class="col-12 mb-1">
                                    ...
                                    <input class="form-control" name="course_sub_category_desc" id="course_sub_category_desc" type="text" value="{{old('course_sub_category_desc')}}">
