            ...
            <div class="card mb-3">
                <div class="card-body">
                  <div class="row flex-between-center">
                    <div class="col-md">
                      <h5 class="mb-2 mb-md-0">Detail informations</h5>
                    </div>
                    <div class="col-auto">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td>{{$data->course_sub_category_name}}</td>
                                  </tr>
                                  <tr>
                                    <td>Title</td>
                                    <td><i class="bi bi-chevron-double-right"></i></td>
                                    <td>{{$data->course_sub_category_title}}</td>
                                  </tr>
                                 
                                  <tr>
                                    <td>Description</td>
                                    <td><i class="bi bi-chevron-double-right"></i></td>
                                    <td>{{$data->course_sub_category_des}}</td>
                                  </tr>
                                  <tr>
                                    <td>Slug </td>
                                    <td><i class="bi bi-chevron-double-right"></i></td>
