...
@section('admin_contents')
    <main>
        <div class="container">
          ...
          <form action="{{route('coursechildcategory.update')}}" method="post" enctype="multipart/form-data">
          @csrf
            <div class="row">
                <div class="col-lg-8">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="row gx-2">
                                ...
                                <div class="col-12 mb-1">
                                  <label class="form-label" for="course_category_id">Categorie Name:</label>
                                  <select name="course_category_id" id="course_category_id" class="form-control">
                                    <option value="{{$data->course_category_id}}">{{$data->courseSubcategory->course_category_name}}</option>
                                    @foreach ($courseCategory as $courseCat)
                                      <option value="{{$courseCat->id}}" {{ old('course_category_id') == $courseCat->id ? 'selected' : '' }}>{{$courseCat->course_category_name}}</option>
                                    @endforeach
                                  </select>
                                  <label class="text-danger fw-medium">@error('course_category_id') {{$message}} @enderror</label>
                              </div>
                                <div class="col-12 mb-1">
                                    <label class="form-label" for="course_sub_category_name">Categorie Name:</label>
                                    <input class="form-control" name="course_sub_category_name" id="course_sub_category_name" type="text" value="{{$data->course_sub_category_name}}">
                                    <label class="text-danger fw-medium">@error('course_sub_category_name') {{$message}} @enderror</label>
                                </div>
                                <div class="col-12 mb-1">
                                    <label class="form-label" for="course_sub_category_title">Categorie Title:</label>
                                    <input class="form-control" name="course_sub_category_title" id="course_sub_category_title" type="text" value="{{$data->course_sub_category_title}}">
                                    <label class="text-danger fw-medium">@error('course_sub_category_title') {{$message}} @enderror</label>
                                </div>
                                <div class="col-12 mb-1">
                                    <label class="form-label" for="course_sub_category_desc">Categorie Descriptions:</label>
                                    <input class="form-control" name="course_sub_category_desc" id="course_sub_category_desc" type="text" value="{{$data->course_sub_category_des}}">
                                    <label class="text-danger fw-medium" >@error('course_sub_category_desc') {{$message}} @enderror</label>
                                </div>
                            </div>
                        </div>
                      </div>
