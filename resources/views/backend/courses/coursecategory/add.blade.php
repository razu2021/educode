...
@section('admin_contents')
    <main>
        <div class="container">
            <div class="card mb-3">
                <div class="card-body">
                  <div class="row flex-between-center">
                    <div class="col-md">
                      <h5 class="mb-2 mb-md-0">Add a Course Categorie</h5>
                    </div>
                    <div class="col-auto">
          ...
          <form action="{{route('coursecategory.submit')}}" method="post" enctype="multipart/form-data">
          @csrf
            <div class="row">
                <div class="col-lg-8">
                    <div class="card mb-3">
                        <div class="card-header bg-body-tertiary">
                          <h6 class="mb-0">Course Categorie information</h6>
                        </div>
                        <div class="card-body">
                            <div class="row gx-2">
                                <div class="col-12 mb-1">
                                    <label class="form-label" for="course_category_name">Categorie Name:</label>
                                    <input class="form-control" name="course_category_name" id="course_category_name" type="text" value="{{old('course_category_name')}}">
                                ...
                                <div class="col-12 mb-1">
                                    ...
                                    <input class="form-control" name="course_category_title" id="course_category_title" type="text" value="{{old('course_category_title')}}">
                                ...
                                <div class="col-12 mb-1">
                                    ...
                                    <input class="form-control" name="course_category_desc" id="course_category_desc" type="text" value="{{old('course_category_desc')}}">
