        ...
        <div class="col-6 col-sm-auto ms-auto text-end ps-0">
          ...
          <div id="table-purchases-replace-element" class="d-flex align-items-center">
            ...
            <a href="{{route('course_review.add')}}">
              ...
              <!-- Filter Button -->
            <a href="{{route('course_review.all')}}">
        ...
        <table class="table table-sm fs-10 mb-0 overflow-hidden">
          <thead class="bg-200">
            <tr class="">
              ...
              <th class="text-900 sort pe-1 align-middle white-space-nowrap" data-sort="name">Question</th>
          ...
          <tbody class="list" id="table-purchase-body">
            ...
            <tr class="btn-reveal-trigger">
              ...
              <td class="align-middle white-space-nowrap phone">{{$data->question ?? 'No Question found !'}}</td>
              ...
              <td class="align-middle white-space-nowrap text-end">
                <div class="dropstart font-sans-serif position-static d-inline-block">
                  ...
                  <div class="dropdown-menu dropdown-menu-end border py-2" aria-labelledby="dropdown-recent-purchase-table-0">
                    ...
                    <form id="deleteForm{{ $data->id }}" action="{{ route('course_review.delete', $data->id) }}" method="POST" style="display: none;">
                      @csrf
                      @method('DELETE')
                    </form>
                    ...
                    <!-- Restore Button with JS Confirm -->
                        ...
                        <!-- Hidden Form -->
                        <form id="restoreForm{{ $data->id }}" action="{{ route('course_review.restore', $data->id) }}" method="POST" style="display: none;">
                        @csrf
